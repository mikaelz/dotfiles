...
plugins=(docker docker-compose copybuffer copyfile copypath dirhistory history git-open git-prompt screen systemd systemadmin zsh-autosuggestions z)
...
alias nethogs='sudo nethogs enp6s0'
